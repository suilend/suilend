module spec::dummy_pool {
    public struct DummyPool has drop {}
}

// Wrap all functions, only allowing DummyPool as the pool type
...
module spec::dummy_pool_lending_market {
    ...
    public fun refresh_reserve_price(
        ...
        suilend::lending_market::refresh_reserve_price<DummyPool>(
            lending_market,
            reserve_array_index,
            clock,
            price_info,
    ...
    public fun deposit_liquidity_and_mint_ctokens<T>(
        ...
        suilend::lending_market::deposit_liquidity_and_mint_ctokens<DummyPool, T>(
            lending_market,
            reserve_array_index,
            clock,
            deposit,
    ...
    public fun redeem_ctokens_and_withdraw_liquidity<T>(
        ...
        suilend::lending_market::redeem_ctokens_and_withdraw_liquidity<DummyPool, T>(
            lending_market,
            reserve_array_index,
            clock,
            ctokens,
    ...
    public fun redeem_ctokens_and_withdraw_liquidity_request<T>(
        ...
        suilend::lending_market::redeem_ctokens_and_withdraw_liquidity_request<DummyPool, T>(
            lending_market,
            reserve_array_index,
            clock,
            ctokens,
    ...
    public fun deposit_ctokens_into_obligation<T>(
        ...
        suilend::lending_market::deposit_ctokens_into_obligation<DummyPool, T>(
            lending_market,
            reserve_array_index,
    ...
    public fun borrow<T>(
        ...
        suilend::lending_market::borrow<DummyPool, T>(
            lending_market,
            reserve_array_index,
            obligation_owner_cap,
            clock,
    ...
    public fun compound_interest(
        ...
        suilend::lending_market::compound_interest<DummyPool>(
            lending_market,
            reserve_array_index,
            clock,
        )
    ...
    public fun borrow_request<T>(
        ...
        suilend::lending_market::borrow_request<DummyPool, T>(
            lending_market,
            reserve_array_index,
            obligation_owner_cap,
            clock,
    ...
    public fun fulfill_liquidity_request<T>(
        ...
        suilend::lending_market::fulfill_liquidity_request<DummyPool, T>(
            lending_market,
            reserve_array_index,
            liquidity_request,
            ctx,
    ...
    public fun withdraw_ctokens<T>(
        ...
        suilend::lending_market::withdraw_ctokens<DummyPool, T>(
            lending_market,
            reserve_array_index,
            obligation_owner_cap,
            clock,
    ...
    public fun liquidate<Repay, Withdraw>(
        ...
        suilend::lending_market::liquidate<DummyPool, Repay, Withdraw>(
            lending_market,
            obligation_id,
    ...
    public fun repay<T>(
        ...
        suilend::lending_market::repay<DummyPool, T>(
            lending_market,
            reserve_array_index,
            obligation_id,
            clock,
    ...
    public fun forgive<T>(
        ...
        suilend::lending_market::forgive<DummyPool, T>(
            cap,
            lending_market,
            reserve_array_index,
            obligation_id,
    ...
    public fun claim_rewards<RewardType>(
        ...
        suilend::lending_market::claim_rewards<DummyPool, RewardType>(
            lending_market,
            cap,
            clock,
            reserve_id,
    ...
    public fun claim_rewards_and_deposit<RewardType>(
        ...
        suilend::lending_market::claim_rewards_and_deposit<DummyPool, RewardType>(
            lending_market,
            obligation_id,
            clock,
            reward_reserve_id,
    ...
    public fun init_staker<S: drop>(
        ...
        suilend::lending_market::init_staker<DummyPool, S>(
            lending_market,
            cap,
            sui_reserve_array_index,
            treasury_cap,
            ctx,
        )
    }
    ...
    public fun rebalance_staker(
        ...
        suilend::lending_market::rebalance_staker<DummyPool>(
            lending_market,
            sui_reserve_array_index,
            system_state,
            ctx,
    ...
    public fun unstake_sui_from_staker(
        ...
        suilend::lending_market::unstake_sui_from_staker<DummyPool>(
            lending_market,
            sui_reserve_array_index,
            liquidity_request,
            system_state,
    ...
    public fun add_reserve<T>(
        ...
        suilend::lending_market::add_reserve<DummyPool, T>(
            cap,
            lending_market,
            price_info,
            config,
    ...
    public fun update_reserve_config<T>(
        ...
        suilend::lending_market::update_reserve_config<DummyPool, T>(
            cap,
            lending_market,
            reserve_array_index,
            config,
    ...
    public fun change_reserve_price_feed<T>(
        ...
        suilend::lending_market::change_reserve_price_feed<DummyPool, T>(
            cap,
            lending_market,
            reserve_array_index,
            price_info_obj,
    ...
    public fun add_pool_reward<RewardType>(
        ...
        suilend::lending_market::add_pool_reward<DummyPool, RewardType>(
            cap,
            lending_market,
            reserve_array_index,
            is_deposit_reward,
    ...
    public fun cancel_pool_reward<RewardType>(
        ...
        suilend::lending_market::cancel_pool_reward<DummyPool, RewardType>(
            cap,
            lending_market,
            reserve_array_index,
            is_deposit_reward,
    ...
    public fun close_pool_reward<RewardType>(
        ...
        suilend::lending_market::close_pool_reward<DummyPool, RewardType>(
            cap,
            lending_market,
            reserve_array_index,
            is_deposit_reward,
    ...
    public fun update_rate_limiter_config(
        ...
        suilend::lending_market::update_rate_limiter_config<DummyPool>(
            cap,
            lending_market,
            clock,
            config,
    ...
    public fun set_fee_receivers(
        ...
        suilend::lending_market::set_fee_receivers<DummyPool>(
            cap,
            lending_market,
            receivers,
            weights,
    ...
    public fun new_obligation_owner_cap(
        ...
        suilend::lending_market::new_obligation_owner_cap<DummyPool>(
            cap,
            lending_market,
            obligation_id,
            ctx,
...
module spec::dummy_pool_obligation {
    use spec::dummy_pool::DummyPool;
    ...
    public fun withdraw(
     ...
     public fun liquidate(
        ...
        obligation::liquidate(obligation, reserves, repay_reserve_array_index, withdraw_reserve_array_index, clock, repay_amount)
    }
