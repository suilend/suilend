...
module suilend::decimal_tests {
    ...
    fun test_basic() {
        ...
        assert!(saturating_floor(from(18446744073709551615)) == 18446744073709551615);
        assert!(saturating_floor(add(from(18446744073709551615), from(1))) == 18446744073709551615);
        assert!(from_u128(340282366920938463463374607431768211455).add(from(1)).to_scaled_val() == 340282366920938463463374607431768211456 * 1000000000000000000);
    }
